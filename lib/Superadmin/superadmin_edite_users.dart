...
class SuperAdminEditUser extends StatefulWidget {
  final Utilisateur utilisateur;

  const SuperAdminEditUser({super.key, required this.utilisateur, required Utilisateur user});

  @override
  State<SuperAdminEditUser> createState() => _SuperAdminEditUserState();
}

class _SuperAdminEditUserState extends State<SuperAdminEditUser> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Éditer utilisateur (SuperAdmin)'),
          ...
          child: Column(
            ...
            children: <Widget>[
              const Text('Informations personnelles',
                  style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF13132D))),
