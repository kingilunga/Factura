...
class AfficherClientsPage extends StatefulWidget {
  const AfficherClientsPage({super.key});

  @override
  State<AfficherClientsPage> createState() => _AfficherClientsPageState();
}

class _AfficherClientsPageState extends State<AfficherClientsPage> {
  ...
  Future<void> _loadClients() async {
    ...
    try {
      ...
      setState(() {
        _clients = clients;
        _filterClients(); // Re-filtre après le chargement pour mettre à jour la liste filtrée
        _isLoading = false;
      });
    } catch (e) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          // NOTE: Le bouton "Ajouter un client" a été retiré, car les clients sont créés lors des achats.
        ],
      ),
      body: Column(
        children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () {
                                  // TODO: Remplacer par la navigation vers la page d'édition
